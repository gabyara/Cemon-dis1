...
<html lang="en">
    ...
    <?php 
		...
		$ModifClientStaff = new Clients_Staff();
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<?php 
									...
									{
										$ModifClientStaff->id = $_REQUEST['id'];
										$ModifClientStaff->rif = $_POST['rif'];
										$ModifClientStaff->surname = $_POST['surname'];
										$ModifClientStaff->address = $_POST['address'];
										$ModifClientStaff->city = $_POST['city'];
										$ModifClientStaff->pass = $_POST['password2'];
										$ModifClientStaff->phonenumber = $_POST['phone'];
										$ModifClientStaff->empresa = $_POST['empresa'];
										$ModifClientStaff->departamento = $_POST['departamento'];
										
										$Persistencia->ModificarClientStaff($ModifClientStaff);
										if($Persistencia){
											include('../view/confirm-clientedit.php');
											unset($_POST['clientedit']);
										}else{
											include('../view/error-clientedit.php');
											}
									}else{
										include('../view/form-clientsedit.php');
										}
								?>
