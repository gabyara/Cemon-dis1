				...
				<table id="dynamic-table" class="table table-striped table-bordered table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="supporttickets.php?view=view&tid=<?php echo $RegistTickets['tid'] ?>">#<?php echo $RegistTickets['tid'] ?> - <?php echo $RegistTickets['title'] ?></a></td>
				...
				<table id="dynamic-table2" class="table table-striped table-bordered table-hover">
					...
					<tbody>
						...
						<td><?php echo $RegistFactura['id'] ?></td>
							<td class="hidden-480">
								<?php setlocale(LC_ALL,"es_ES"); echo date("j M, Y, (g:i a)", strtotime(date($RegistFactura['datee'])));?>		
							</td>
							<td><?php echo $RegistFactura['subject'] ?></td>
							<td style="display:none"></td>
                            <td style="display:none"></td>
                            <td style="display:none"></td>
                            <td>por definir</td>
