...
<form class="form-horizontal" id="validation-form" method="post" action="">
  ...
  <!--  
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="phone">Departamento:</label>
        ...
        <div class="col-xs-12 col-sm-9">
            <div class="input-group">
                ...
                <input required="required" type="tel" id="departamento" name="departamento" value="<?php if(isset($_POST['departamento'])){echo $_POST['departamento'];} ?>" />
            </div>
        </div>
    </div>
-->
