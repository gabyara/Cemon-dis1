    ...
    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
        <thead>
            <tr>
                ...
                <th style="display:none"><center></center></th>
                <th><center>Dir. Origen</center></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="display:none"><center></center></td>    
                 <td>
                   <center><?php echo $RegistTickets['DirOrigen'] ?></center>
                </td>
                <td>
                ...
                <td class="hidden-480">
                    <center><?php setlocale(LC_ALL,"es_ES"); echo date("j M, Y, (g:i a)", strtotime(date($RegistTickets['date'])));?></center>		
                </td>
